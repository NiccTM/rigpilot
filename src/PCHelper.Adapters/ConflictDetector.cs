...
public static class ConflictDetector
{
    ...
    [
        ...
        new("afterburner", "MSI Afterburner", ["MSIAfterburner"], ["GpuTuning", "GpuFan"], "Disable overlapping PC Helper GPU writes or close Afterburner."),
        ...
        new("ai-suite", "ASUS AI Suite", ["AISuite3", "FanXpert"], ["MotherboardFan", "CpuTuning"], "Disable Fan Xpert ownership before enabling PC Helper fan writes."),
        ...
        new("openrgb", "OpenRGB", ["OpenRGB"], ["Lighting"], "PC Helper may bridge to OpenRGB, but must not compete with another OpenRGB client."),
