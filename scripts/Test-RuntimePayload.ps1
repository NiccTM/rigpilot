...
$requiredFeatures = @("service-status", "capability-v2", "fan-commissioning", "fan-calibrations", "reliability", "adapter-trace", "cooling-output-roles", "release-write-policy", "auto-oc-v3", "profile-dry-run-v1", "auto-oc-validation-v1")
