...
```powershell
.\scripts\build-gamebar.ps1 -Version 0.8.0-beta.1 -SigningCertificateThumbprint <certificate-thumbprint>
```
...
```powershell
.\scripts\Test-RuntimePayload.ps1 -PayloadRoot .\artifacts\publish -ExpectedProductVersion 0.8.0-beta.1
